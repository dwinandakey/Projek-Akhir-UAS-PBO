...
public class Parkir {
    ...
    public Parkir(String nama, String nomorKendaraan, String waktuMasuk, String waktuKeluar, Integer durasi, Integer biaya, Integer civitas, String jenisKendaraan) {
        this.nama = nama;
